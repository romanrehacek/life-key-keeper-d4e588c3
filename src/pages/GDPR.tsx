...
const GDPR = () => {
  return (
    <PageTemplate title="GDPR">
      <Helmet>
        <title>GDPR | Životný kľúč</title>
        <meta name="description" content="Informácie o spôsobe, akým Životný kľúč spracúva a chráni vaše osobné údaje v súlade s nariadením GDPR." />
        <meta name="keywords" content="GDPR, ochrana osobných údajov, životný kľúč, digitálne dedičstvo" />
      </Helmet>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="prose prose-slate max-w-none prose-headings:font-bold prose-headings:text-foreground prose-p:text-muted-foreground prose-li:text-muted-foreground prose-p:my-4 prose-li:my-1 prose-headings:mt-8 prose-headings:mb-4">
          ...
          <ul className="my-4 space-y-2">
            ...
            <li>Zaslaním e-mailu na adresu <a href="mailto:gdpr@zivotny-kluc.sk" className="text-lifekey-teal hover:underline">gdpr@zivotny-kluc.sk</a></li>
